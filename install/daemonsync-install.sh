...
msg_info "Installing Daemon Sync Server [Deactivated by levid0s until security analysis]"
# wget -qL https://github.com/com unity-scripts/ProxmoxVE/raw/main/misc/daemonsync_2.2.0.0059_amd64.deb
