...
function clean_container() {
  ...
  echo "WARINING: functino deactivated by levid0s until security review."
  pause
  # pct exec $container -- bash -c "apt-get -y --purge autoremove && apt-get -y autoclean && bash <(curl -fsSL https://github.com/commu nity-scripts/ProxmoxVE/raw/main/misc/clean.sh) && rm -rf /var/lib/apt/lists/* && apt-get update"
}
